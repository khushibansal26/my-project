...
function Navbar() {
  ...
  return (
    <div className={`nav ${show && "bg-black"}  flex justify-between fixed top-0 w-full p-5 h-14 z-10 ease-in transition-all	`}>
        <img
        className='nav-logo w-20 object-contain fixed left-5'
        src=" https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Netflix_2015_logo.svg/1198px-Netflix_2015_logo.svg.png "
        ></img>
        
        <img 
        className='nav-avatar w-7 object-contain fixed right-5'
